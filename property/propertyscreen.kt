package com.example.merchpr.ui.theme.screens.property
...
fun PropertyScreen(navController: NavController){
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    title = { Text(text = "Top Tier Homes") }
                )
            },
                ...
                Column(
                    ...
                    Row {
                        ...
                        Column(modifier = Modifier.padding(start = 20.dp)) {
                            Text(text = "Visit Kaplions", fontSize = 20.sp)
                            ...
                            Text(text = "100,000 reviews")
                            Button(
                                onClick = {
                                    val callIntent= Intent(Intent.ACTION_DIAL)
                                    callIntent.data="tel:0795500212".toUri()
                    ...
                    Button(
                        onClick = {
                            ...
                            smsIntent.data = "sms to: 0795500212".toUri()
